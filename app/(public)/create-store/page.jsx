    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data.status)) {
        ...
        switch (data.status) {
          ...
          case "rejected":
            setMessage(
              "Your store has been rejected. Please contact the admin for more details."
            )
            break

          case "pending":
            setMessage(
              "Your store request is pending. Please wait for the admin to approve it."
            )
            break
          ...
          >
            ...
            <div>
              ...
              <p className="max-w-lg">
                To become a seller on Scottin.dot, submit your store details for
